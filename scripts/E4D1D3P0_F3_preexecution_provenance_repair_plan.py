...
e4a2e_kv={}
for _line in txt["E4A2E"].splitlines():
    if "=" in _line and not _line.lstrip().startswith("#"):
        _k,_v=_line.split("=",1)
        e4a2e_kv.setdefault(_k.strip(),_v.strip())
assert "E4A2D_FIRST_CPS_I_INFERENCE_EXECUTION=PASS" not in txt["E4A2E"]
assert e4a2e_kv["CPS_I_VALUES_NEWLY_READ"]=="0"
assert e4a2e_kv["I_EMPIRICALLY_TESTED"]=="1"
assert e4a2e_kv["K_EMPIRICALLY_TESTED"]=="0"
assert e4a2e_kv["D_EMPIRICALLY_TESTED"]=="0"
assert e4a2e_kv["SCF_SYNTHETIC_MI_REPLICATE_ENGINE_PREFLIGHT"]=="PASS"
assert e4a2e_kv["E4A2E_EXACT_SCF_REPLICATE_MI_ENGINE_PREFLIGHT"]=="PASS"
...
["SCF","E4A2E_AUDIT","data/metadata/E4D1D_2019_runtime/SCF/E4A2E_exact_scf_replicate_mi_engine_preflight_audit.txt","CPS_I_STATE_DEPENDENT_SYNTHETIC_PREFLIGHT","REGENERATE_AFTER_CPS_PASS","Regenerate frozen synthetic preflight after frozen 2019 CPS I PASS; preflight reads zero new CPS I values"],
]
...
["P5R1","SCF","2019_BOUND_ENGINE_PREFLIGHT","SYNTHETIC_AFTER_CPS_PASS","Regenerate E4A2E preflight using frozen engine after frozen 2019 CPS I PASS; read zero new I values","0_KD"],
