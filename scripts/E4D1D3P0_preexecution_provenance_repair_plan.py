...
# Existing 2019 schema compatibility must be frozen.
schema=rows(BR_SCHEMA)
acs_schema=[r for r in schema if r.get("family")=="ACS"]
assert acs_schema and all(r.get("status")=="PASS" for r in acs_schema)
