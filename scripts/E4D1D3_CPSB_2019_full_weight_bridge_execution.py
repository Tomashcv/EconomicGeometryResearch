...
CONTRACT = ROOT / "data/metadata/E4D1D3_CPSB_P0_2019_full_weight_bridge_execution_contract.json"
...
CPS_MAIN = ROOT / "data/raw/cps_asec/2019/asec2019_pubuse.zip"
...
CPS_PERSON = ROOT / "data/raw/cps_asec/2019/persfmt.txt"
CPS_HOUSE = ROOT / "data/raw/cps_asec/2019/hhldfmt.txt"
...
if c["contract_id"] != "E4D1D3_CPSB_2019_FULL_WEIGHT_BRIDGE_V1":
    raise RuntimeError("unexpected E4D1D3 CPSB contract")
...
with unique_zip_member(
    ...
    with zf.open("asec2019_pubuse.dat", "r") as raw:
        for bline in raw:
            line = bline.rstrip(b"\r\n")
...
lines = [
    ...
    (
        ...
        "E4D1D3_CPSP_PREDECESSOR_SHA_PATCH_AUTHORIZED=0"
    ),
]
